...
setTimeout(() => {
    document.querySelector('iframe').contentDocument.querySelector('.add')
...
document.querySelector('.set').addEventListener('click', (ev) =>{
    ...
    let newCheck = document.querySelector('iframe').contentDocument.querySelectorAll('.checkmark');
        newCheck[newCheck.length -1].addEventListener('click', (ev) => {
        let classArr = ev.target.parentElement.parentElement.classList;
        let prefs = document.querySelector('iframe').contentDocument.querySelectorAll('.pref');
    ...
    let newPref = document.querySelector('iframe').contentDocument.querySelectorAll('.pref');
    newPref[newPref.length-1].addEventListener('click',(ev) => {
        let pref = ev.target, check = pref.nextElementSibling;
        let classArr = ev.target.parentElement.parentElement.classList;
        let newSelect = document.querySelector('iframe').contentDocument.querySelectorAll('.select');
    ...
    let timeClass = document.querySelector('iframe').contentDocument.querySelectorAll('.time')
    [document.querySelector('iframe').contentDocument.querySelectorAll('.time').length -1];
    ...
    document.querySelector('iframe').contentDocument.querySelectorAll('.delete')
    [document.querySelector('iframe').contentDocument.querySelectorAll('.delete').length -1]
    .addEventListener('click', (ev) => {
